...
define PI_BLUETOOTH_INSTALL_TARGET_CMDS
	$(INSTALL) -d $(TARGET_DIR)/etc/systemd/system/lva-os-hardware.target.wants
	$(INSTALL) -m 0644 $(BR2_EXTERNAL_LVA_OS_PATH)/package/pi-bluetooth/hciuart.service $(TARGET_DIR)/usr/lib/systemd/system/
	$(INSTALL) -m 0644 $(BR2_EXTERNAL_LVA_OS_PATH)/package/pi-bluetooth/hciunbind.service $(TARGET_DIR)/usr/lib/systemd/system/
	$(INSTALL) -m 0644 $(BR2_EXTERNAL_LVA_OS_PATH)/package/pi-bluetooth/bthelper@.service $(TARGET_DIR)/usr/lib/systemd/system/
